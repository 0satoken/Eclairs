  ...
  switch(a){
    case DENS:
      if(x < 10.0 && fabs(x-1.0) > 0.01){
        ...
        res = - 11.0/126.0 + (x-1.0)/126.0
              - 29.0/252.0 * sqr(x-1.0);
      }
      else if(x >= 10.0){
        res = - 61.0/630.0 + 2.0/105.0/(x*x)
              - 10.0/1323.0/qua(x);
      }
      res /= x*x;
      break;
    case VELO:
      if(x < 10.0 && fabs(x-1.0) > 0.01){
        ...
        res = - 3.0/14.0 - 5.0/42.0*(x-1.0)
            + sqr(x-1.0)/84.0;
      }
      else if(x >= 10.0){
        res = - 3.0/10.0 + 26.0/245.0/(x*x)
              - 38.0/2205.0/qua(x);
      }
      res /= x*x;
      break;
  ...
  switch(a){
    case DENS:
      if(fabs(fabs(y)-1.0) < 0.05){
        res = 120424.0 / 3009825.0 +
              (2792.0*sqr(1.0 - fabs(y)))/429975.0 +
        ...
        res = (2.0*(1.0 + sqr(y))*(-11191.0 + 118054.0*sqr(y) -
              18215.0*qua(y) + 18215.0*sqr(qua(y)) - 118054.0*(y*cub(cub(y))) +
              11191.0*qua(cub(y)) + 60.0*qua(y)*(3467.0 - 790.0*sqr(y) +
              3467.0*qua(y))*log(sqr(y)))) /
    ...
    case VELO:
      if(fabs(fabs(y)-1.0) < 0.05){
        ...
        res = (2.0*(1.0 + sqr(y))*(-54373.0 + 562162.0*sqr(y) -
               408245.0*qua(y) + 408245.0*sqr(qua(y)) - 562162.0*(y*cub(cub(y))) +
               54373.0*qua(cub(y)) + 60.0*qua(y)*(14561.0 - 10690.0*sqr(y) +
               14561.0*qua(y))*log(sqr(y)))) /
...
double cc(Type a, double qs){
  ...
  switch(a){
  case DENS:
    res = 0.02088557981734545 / (35.09866396385646*qua(qs) +
          4.133811416743832*sqr(qs) + 1.0) -
  ...
  case VELO:
    res = - 0.008217140060512867 / (42.14072830553836*qua(qs) +
            ...
            0.01099093588476197*cub(qs) / (28.490424851390667*sqr(qua(qs)) + 1.0);
    break;
  default:
    res = 0.0;
    break;
...
double dd(Type a, double qr){
  ...
  case DENS:
    res = - 0.022168478217299517 / (7.030631093970638*qua(qr) +
          ...
          0.009267495321465601*sqr(qr) / (4.11633699497035*(qr*cub(cub(qr))) + 1.0);
    break;
  case VELO:
    res = 0.008023147297149955 / (2.238261369090066*sqr(qr)*cub(qr) +
          1.0) - 0.006173880966928251*sqr(qr) /
...
double delta(Type a, double qs){
  ...
  switch(a){
  case DENS:
    res = 0.3191221482038663*qua(qs_) /
          (1.3549058352752525*qua(qs_) + 1.0)
        + 1.2805575495849764 / (18.192939946270577*qua(qs_) +
          3.98817716852858*sqr(qs_) + 1.0) + 0.764469131436698;
    break;
  case VELO:
    res = 1.528058751211026 * (2.4414566000839355*qua(qs_) +
          1.8616263354608626*sqr(qs_)) /
          (2.4414566000839355*qua(qs_) + 1.0) +
          2.5227965281961247 / (0.0028106312591877226*qua(qs_) +
          1.0332351481570086*sqr(qs_) + 1.0) - 0.528058751211026;
    break;
  default:
    res = 0.0;
    break;
