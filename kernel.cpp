...
double F4_sym(Type a, Vector p, Vector q, Vector r, Vector s){
  ...
  res = ( F4a(a, p, q, r, s) + F4a(a, s, p, q, r) +
          F4a(a, r, s, p, q) + F4a(a, q, r, s, p) )/4.0 +
        ( F4b(a, p, q, r, s) + F4b(a, p, r, q, s) +
          F4b(a, p, s, q, r) + F4b(a, r, s, p, q) +
          F4b(a, q, s, p, r) + F4b(a, q, r, p, s) )/6.0;
